                    ...
                    <div class="row">
                        ...
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 text-end">
                            <div class="icon icon-shape bg-gradient-primary shadow float-end border-radius-md">
                                <img class="w-100 " src={{ asset('images/product.jpg') }} width="50" height="75"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-plain h-100 bg-white">
                <div class="p-3">
                    <div class="row">
                        ...
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 text-end">
                            <div class="icon icon-shape bg-gradient-primary shadow float-end border-radius-md">
                                <img class="w-100 " src={{ asset('images/category.png') }} width="50" height="75"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-plain h-100 bg-white">
                <div class="p-3">
                    <div class="row">
                        ...
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 text-end">
                            <div class="icon icon-shape bg-gradient-primary shadow float-end border-radius-md">
                                <img class="w-100 " src={{ asset('images/customer.jpg') }} width="50" height="75"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-plain h-100  bg-white">
                <div class="p-3">
                    <div class="row">
                        ...
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 text-end">
                            <div class="icon icon-shape bg-gradient-primary shadow float-end border-radius-md">
                                <img class="w-100 " src={{ asset('images/invoice.jpg') }} width="50" height="75"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-plain h-100 bg-white">
                <div class="p-3">
                    <div class="row">
                        ...
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 text-end">
                            <div class="icon icon-shape bg-gradient-primary shadow float-end border-radius-md">
                                <img class="w-100 " src={{ asset('images/sale.jpg') }} width="50" height="75"/>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    async function getList() {
        ...
        let res=await axios.get("/dashsum");
